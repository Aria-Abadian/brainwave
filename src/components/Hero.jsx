      ...
      <div className="container relative" ref={parallaxRef}>
        ...
        >
          ...
          <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
            Unleash the power of AI within XERO Ai. Upgrade your productivity
            with XERO Ai, the open AI chat app.
          </p>
        ...
        >
          <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
            <div className="relative bg-n-8 rounded-[1rem] ">
              ...
              <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1042/490]">
                <img
                  src={robot}
                  alt="AI"
          ...
          <div
            className="absolute -top-[54%] left-1/2 w-[230%] -translate-x-1/2 md:-top-[46%] md:w-[138%]
          lg:-top-[104%]"
          >
            <img
              src={heroBackground}
